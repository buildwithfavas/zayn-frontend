            ...
            <div className="w-full lg:w-1/2 max-w-md order-1 lg:order-1">
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 sm:p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex gap-6">
                      <label className="flex items-center">
                        <input
                          ...
                          className="mr-2 h-4 w-4 text-gray-900 border-gray-400 focus:ring-gray-500 focus:ring-2"
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600 mt-2">
                      Minimum 8 characters with at least one upper case, one lower case, one special character and a number
                    </p>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    >
                      By clicking 'Log In' you agree to our website Al Zayn Club{" "}
                ...
                <div className="mt-4 text-center text-sm text-gray-700">
                  ...
                  <Link to="/login" className="text-gray-900 font-semibold underline hover:text-gray-700">
                    Login
                  </Link>
                </div>
              </div>
