  ...
  return (
    <div className="pt-8 pb-4 relative w-full overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="absolute right-3 sm:right-6 -top-7 sm:-top-8 flex gap-1.5 sm:gap-2 z-10">
          {/* Left Arrow */}
          <button
            onClick={() => scroll('left')}
        ...
        >
          {(isConstrained ? (() => {
            ...
            <a
              ...
              style={isConstrained ? { width: itemsPerPage === 3 ? 'calc(33.333% - 1rem)' : 'calc(50% - 1rem)' } : undefined}
            >
              {/* Circle Image */}
